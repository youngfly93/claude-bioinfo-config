...
- **harness_bio**（GitHub: youngfly93/harness_bio，本地 `/Volumes/KINGSTON/work/yang_lab/harness_bio`）：从 116 个真实生信外包 session 提炼的**工程级、契约化、可测试**治具（32 测试全绿，9.6/10）。file-based，agent 无关。
...
3. 已知安装路径 /Volumes/KINGSTON/work/yang_lab/harness_bio
